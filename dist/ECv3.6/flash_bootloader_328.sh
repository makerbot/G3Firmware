...
FIRMWARE=ATmegaBOOT_168_atmega328
FWDIR=`dirname $0`
...
while true; do
    ...
    $AVRDUDE $CONF_FLAGS -v -pm328p -cusbtiny -e -Ulock:w:0x3F:m -Uefuse:w:0x05:m -Uhfuse:w:0xda:m -Ulfuse:w:0xff:m 
    # Burn firmware
    $AVRDUDE $CONF_FLAGS -v -pm328p -cusbtiny -Uflash:w:${FWDIR}/${FIRMWARE}.hex:i -Ulock:w:0x0F:m
done
